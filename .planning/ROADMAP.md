...
**Plans:** 2/2 plans complete
Plans:
- [x] 28-01-PLAN.md — TDD collectTrackedFolders and reconcileSentinels (lifecycle.ts)
- [x] 28-02-PLAN.md — Wire lifecycle into startup sequence and config change handlers
